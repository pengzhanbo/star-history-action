...
// star-history.com favicon, embedded as a data URL so the watermark renders
// without any external asset fetch.
//
// star-history.com 的站点图标，以 data URL 内嵌，水印渲染无需额外资源请求。
const iconBase64 =
